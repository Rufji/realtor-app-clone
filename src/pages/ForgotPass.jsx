        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form  action="">
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p><Link className='text-blue-400 hover:text-blue-700 transition duration-200 ease-in-out' to="/Signin">Sign In</Link></p>
            </div>
            <button className='w-full bg-blue-400 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover: bg-blue-700 transition duration-150 ease-in-out hover: shadow-lg active:bg-blue-800' type='submit'>Reset Password</button>
