    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form  action="">
            <input  type="text" value={name} id='name' placeholder='Full Name' onChange={onChange} className='w-full mb-6 px-4 py-2 text-xl text-gray-500 bg-white border-gray-300 rounded transition ease-in-out'/>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p className='mb-6'>Have an account?
                <Link className='text-red-400 hover:text-red-700 transition duration-200 ease-in-out' to="/Signin"> Login</Link>
              </p>
            ...
            <button className='w-full bg-blue-400 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover: bg-blue-700 transition duration-150 ease-in-out hover: shadow-lg active:bg-blue-800' type='submit'>Sign Up</button>
